    ...
    public class CATConnectorTest : IClassFixture<TestFixture>
    {
        ...
        public void Test_CreateDoc()
        {
            var catConnector = new CATConnector(_testFixture.DbContextContainer, _testFixture.MockConfiguration.Object, 
                _testFixture.MockedMachineTranslators, _testFixture.MockLanguageService.Object, _testFixture.MockCatClientFactory.Object, 
                _testFixture.MockMapper.Object,
                _testFixture.GetLoggerMockObject<CATConnector>(), 
