...
namespace cat.utils
{
    ...
    {
        private static readonly String termbasesConnectionString = WebConfigurationManager.AppSettings["TermbasesConnectionString"];
        private static readonly String translationMemoriesConnectionString = WebConfigurationManager.AppSettings["TranslationMemoriesConnectionString"];
        private static readonly String translationsConnectionString = WebConfigurationManager.AppSettings["TranslationsConnectionString"];

        public static readonly String tmRepository = WebConfigurationManager.AppSettings["TMPath"];
        private static readonly Logger logger = new Logger();
        private static readonly Dictionary<String, String> sqlCommands = new Dictionary<String, String>();

        private class DBParams
        {
            public String dbName;
            public String tmTableName;
        }
        ...
        public void CreateTranslationMemory(String tmPath)
        {
            try
            {
                ...
                var tmDir = Path.Combine(tmRepository, dbParams.dbName);
                ...
                var connectionString = String.Format(translationMemoriesConnectionString, "");
                ...
                connectionString = String.Format(translationMemoriesConnectionString, dbName);
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    sqlConnection.Open();
        ...
        public bool TMExists(String tmPath)
        {
            ...
            connectionString = String.Format(translationMemoriesConnectionString, dbParams.dbName);
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                //check if the table exists
        ...
        {
            var dbParams = GetDBParams(tmPath);
            var connectionString = String.Format(translationMemoriesConnectionString, dbParams.dbName);
        ...
        {
            var connectionString = String.Format(translationMemoriesConnectionString, "master");
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
        ...
        {
            /*var connectionString = String.Format(translationMemoriesConnectionString, "TranslationMemories");
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                try
                {
