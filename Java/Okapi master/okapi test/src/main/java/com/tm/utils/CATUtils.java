...
public class CATUtils {
    ...
    public static TextFragment XliffSegmentToTextFragment(String sXliffSegment) {
        ...
        try {
            ...
            String sTmpXliff = "<xliff xmlns='urn:oasis:names:tc:xliff:document:1.2'><trans-unit id='1'><source>"
            ...
            Parameters xliffParams = (net.sf.okapi.filters.xliff.Parameters) filter.getParameters();
            ...
            while (filter.hasNext()) {
                ...
                if (ev.getEventType() == EventType.TEXT_UNIT) {
                    ...
                    TextUnit tu = (TextUnit) ev.getResource();
