...
public class Ocelot extends JPanel
	...
	public static void startOcelot(String filePath) throws IOException, InstantiationException, IllegalAccessException {
		...
		if (filePath != null)
			ocelot.openFile(new File(filePath), true);
	}
