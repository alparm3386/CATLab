...
namespace CAT.Areas.BackOffice.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        {
            var mainDbContext = _context.Companies.Include(c => c.Address);
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyGroupId,Name,AddressId")] Company company)
        {
            ...
            ViewData["AddressId"] = new SelectList(_context.Addresses, "Id", "City", company.AddressId);
            return View(company);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyGroupId,Name,AddressId")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MainDbContext.Companies'  is null.");
            }
            var company = await _context.Companies.FindAsync(id);
            if (company != null)
            {
